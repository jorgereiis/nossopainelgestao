...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cadastros', '0067_tarefa_envio_periodo_obrigatorio'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarefa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='variantes', to='cadastros.tarefaenvio', verbose_name='Tarefa')),
            ],
            options={
