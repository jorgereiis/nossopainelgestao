...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('cadastros', '0065_add_user_fk_to_sessaowpp'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('imagem', models.ImageField(blank=True, help_text='Imagem a ser enviada (opcional). Max 5MB. Formatos: JPG, PNG, GIF, WEBP', null=True, upload_to=cadastros.models.tarefa_envio_imagem_upload_path, validators=[django.core.validators.FileExtensionValidator(['jpg', 'jpeg', 'png', 'gif', 'webp'])], verbose_name='Imagem')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarefa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historico', to='cadastros.tarefaenvio', verbose_name='Tarefa')),
            ],
            options={
