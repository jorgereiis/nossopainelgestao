# Generated by Django 4.2 on 2023-05-21 19:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'data_adesao',
                    models.DateField(
                        default=datetime.date(2023, 5, 21),
                ...
                (
                    'ultimo_pagamento',
                    models.DateField(
                        blank=True, null=True, verbose_name='Último pagamento realizado'
                    ),
                ),
                (
                    'cancelado',
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        unique=True, verbose_name='Quantidade de telas'
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'nome',
                    models.CharField(default='Desconto na mensalidade', max_length=255),
                ),
                (
                    'tipo_plano',
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'valor',
                    models.DecimalField(
                        decimal_places=2, max_digits=5, verbose_name='Valor'
                    ),
                ),
                (
                    'usuario',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'dt_vencimento',
                    models.DateField(
                        default=datetime.date(2023, 6, 20),
        ...
        migrations.AddField(
            ...
            name='servidor',
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='cadastros.servidor'
            ),
        ),
        migrations.AddField(
            model_name='cliente',
