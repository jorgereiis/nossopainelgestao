    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_adesao', models.DateField(default=datetime.date(2023, 5, 29), verbose_name='Data de adesão')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nome', models.CharField(choices=[('Mensal', 'Mensal'), ('Semestral', 'Semestral'), ('Anual', 'Anual')], default='Mensal', max_length=255, verbose_name='Nome do plano')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_vencimento', models.DateField(default=datetime.date(2023, 6, 28), verbose_name='Data do vencimento')),
