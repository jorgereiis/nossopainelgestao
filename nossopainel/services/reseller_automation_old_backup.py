...
Uso:
    from nossopainel.services.reseller_automation import DreamTVAutomation
...
from nossopainel.utils import decrypt_password
from nossopainel.services.logging_config import get_reseller_logger
from nossopainel.services.capsolver_integration import (
    CapSolverException,
    CapSolverService,
)
...
class DreamTVAutomation(ResellerAutomationService):
    ...
    def _atualizar_dns_dispositivo(
        ...
        from nossopainel.utils import substituir_dominio_em_url, extrair_dominio_de_url
