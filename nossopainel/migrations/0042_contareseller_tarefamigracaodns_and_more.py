...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('nossopainel', '0041_alter_useractionlog_acao'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aplicativo', models.ForeignKey(help_text='Aplicativo/plataforma do reseller (ex: DreamTV, NetFlox)', on_delete=django.db.models.deletion.CASCADE, related_name='contas_reseller', to='nossopainel.aplicativo')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('aplicativo', models.ForeignKey(help_text='Aplicativo/plataforma onde a migração será executada', on_delete=django.db.models.deletion.CASCADE, related_name='tarefas_migracao_dns', to='nossopainel.aplicativo')),
                ('conta_reseller', models.ForeignKey(blank=True, help_text='Conta reseller usada para executar a migração', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='tarefas_migracao', to='nossopainel.contareseller')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tarefa', models.ForeignKey(help_text='Tarefa de migração à qual este dispositivo pertence', on_delete=django.db.models.deletion.CASCADE, related_name='dispositivos', to='nossopainel.tarefamigracaodns')),
            ],
            options={
