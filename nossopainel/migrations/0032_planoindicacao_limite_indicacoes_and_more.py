...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('nossopainel', '0031_uuid_media_filenames'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente_indicado', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='desconto_progressivo_gerado', to='nossopainel.cliente', verbose_name='Cliente Indicado')),
                ('cliente_indicador', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='descontos_progressivos_recebidos', to='nossopainel.cliente', verbose_name='Cliente Indicador')),
                ('plano_indicacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='nossopainel.planoindicacao', verbose_name='Plano de Indicação')),
