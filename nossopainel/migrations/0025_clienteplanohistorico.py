...
def backfill_historico(apps, schema_editor):
    ...
    Plano = apps.get_model('nossopainel', 'Plano')
    Historico = apps.get_model('nossopainel', 'ClientePlanoHistorico')
...
class Migration(migrations.Migration):
    dependencies = [
        ('nossopainel', '0024_alter_plano_nome'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cliente', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='historico_planos', to='nossopainel.cliente')),
                ('plano', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='nossopainel.plano')),
